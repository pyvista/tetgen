...
#define fastlookup(pool, index)                                                              \
    ...
    int
    tri_edge_tail(point, point, point, point, point, point, REAL, REAL, int, int *, int *);
    ...
    int report_selfint_face(
        point, point, point, face *sface, triface *iedge, int intflag, int *types, int *poss);
    ...
    void delaunizecavity(
        arraypool *, arraypool *, arraypool *, arraypool *, arraypool *, arraypool *);
    bool fillcavity(
        arraypool *,
        arraypool *,
        arraypool *,
    ...
    int insertpoint_cdt(
        ...
        arraypool *);
    void refineregion(
        face &, arraypool *, arraypool *, arraypool *, arraypool *, arraypool *, arraypool *);
